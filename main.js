...
function sendBuildTask(roomName, constructionSideID, type, pos) {
    ...
    buildUpgraderContainer() {
        ...
        for (let i = 0; i < 6; ++i) {
            if (i == 0 || i == 2 || i == 5) {
                ...
                CreepSpawning.sendToSpawnInitializacion(this.mainRoom, creepName$1, 'transporter', data, 'dpt_logistic', false);
