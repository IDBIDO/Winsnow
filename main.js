...
class OperationReserch {
    ...
    buildColony() {
        ...
        switch (rcl) {
            ...
            case 1:
                if (fase == 0)
                    this.buildExtensionsAndAdjacentsRoads();
                break;
        }
    }
    /*
        ...
        source: creep => {
            ...
            if (target['id']) {
                ...
                if (contructionSide) { //@ts-ignore
                    ...
                    Game.creeps[creep.memory['logisticCreepName']];
                    //@ts-ignore
                    ...
                    */
                    ...
                    //@ts-ignore
                    if (creep.pos.isEqualTo(contructionSide.pos))
                        return true;
                }
